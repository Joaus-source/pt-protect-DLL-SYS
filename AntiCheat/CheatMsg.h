...
#define SEND_PROTECTED_ACTION_HNADLEPT (int)(1<<0) //句柄保护
#define SEND_PROTECTED_ACTION_MMPT (int)(1<<1)		//内存保护
#define SEND_PROTECTED_ACTION_ANTIDEBUG (int)(1<<2)	//反调试
#define SEND_PROTECTED_ACTION_HIDEPROCESS (int)(1<<3)//进程隐藏

//取消保护
#define CLEAR_PROTECTED_ACTION_HNADLEPT (int)~(1<<0) //句柄保护
#define CLEAR_PROTECTED_ACTION_MMPT (int)~(1<<1)		//内存保护
#define CLEAR_PROTECTED_ACTION_ANTIDEBUG (int)~(1<<2)	//反调试
#define CLEAR_PROTECTED_ACTION_HIDEPROCESS (int)~(1<<3)//进程隐藏
